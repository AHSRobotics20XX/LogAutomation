...
import org.firstinspires.ftc.teamcode.Custom.Helpers.ArrayListClass;
import org.firstinspires.ftc.teamcode.Custom.Helpers.CustomMethods;
import org.firstinspires.ftc.teamcode.Custom.Helpers.FileIOClass;
import org.firstinspires.ftc.teamcode.Custom.Helpers.ParseClass;
import org.firstinspires.ftc.teamcode.Custom.Helpers.ThreadClass;
...
public class AppendAutonomous extends LinearOpMode
{
    ...
    //Global Variables
    private String programName = environmentConst.programName;
    private boolean CreateDebugFile = environmentConst.CreateDebugFile;
    private boolean CreateMergeLogFile = environmentConst.CreateMergeLogFile;
    private boolean firstCreation = false;
    private String VuforiaKey = environmentConst.VuforiaKey;
    private String rawConfigLine;
    private String strippedConfigLine;
    private ArrayList<String> rawLogLine = new ArrayList<>();
    private ArrayList<String> strippedLogLine = new ArrayList<>();
    private String runPattern;
    private String strippedRunPattern;
    private ArrayList<String> bufferedAutonomous = new ArrayList<>();
    private ArrayList<String> bufferedDebug = new ArrayList<>();
    private ArrayList<String> lstActions = new ArrayList<>();

    //File Locations
    private String InitialDirectory = environmentConst.Directory;
    private String ReadLogsFilePath = InitialDirectory + "/CustomLog/RecordingLog.txt";
    private String AutonomousFilePath = InitialDirectory + "/CustomLog/" + programName + ".java";
    private String MergedLogsFilePath = InitialDirectory + "/CustomLog/MergeLogs/" + programName + "_Mergedlogs.txt";
    private String DebugFilePath = InitialDirectory + "/CustomLog/DebugFiles/" + programName + "_Debug.txt";
    private String RunPatternFilePath = InitialDirectory + "/CustomLog/ActionPattern/" + programName + "_ActionPattern.txt";

    @Override
    public void runOpMode()
    {
        waitForStart();
        customMethods.CheckDirectories(InitialDirectory);
    ...
    {
        customMethods.CheckLogFile(ReadLogsFilePath);
        ...
        lstActions = customMethods.FileDetectActionPatterns(ReadLogsFilePath);
        runPattern = customMethods.FileDetectRunPattern(RunPatternFilePath);
    ...
    public void ReplaceDetectionImports()
    {
    ...
    public void ReplaceProgramDeclarations()
    {
    ...
    public void ReplaceOpModeDeclarations()
    {
    ...
    //region Move Methods
    public void CreateMove01Method(int beginIndex, int endIndex)
    {
        //MethodCall
    ...
    public void AppendMove(int beginIndex, int endIndex)
    {
        ArrayList<String> methodContents = new ArrayList<>();
    ...
    public void AppendDetect(int beginIndex, int endIndex, String runPattern)
    {
        ArrayList<String> methodContents = new ArrayList<>();
        for (int i = 0; i < parseClass.DetectionCount(); i++)
        {
    ...
    public void AutonomousCreateObjectDetectionLogicMethod()
    {
...
//            bufferedAutonomous.add("");
    ...
    public double GetMilliseconds(String NextTime, String CurrentTime)
    {
    ...
    public void OutputAutonomousFile()
    {
    ...
    public void OutputDebugFile()
    {
        if (CreateDebugFile)
        {
            ...
            else
            {
                ...
                customMethods.CheckIfConfigsEqual(bufferedDebug);
    ...
    public void OutputMergeLogsFile()
    {
    ...
    public void OutputArrayToFile(ArrayList<String> ArrayList, String FilePath)
    {
        threadClass.CreateFileWithBackgroundThread(ArrayList, FilePath, "Config", false);
    }
    //endregion
}
